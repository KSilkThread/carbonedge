...
public class HelperTest {
    ...
    @Test void checkdrift1(){
        QAL3Certificate cert = new QAL3Certificate("sensor", "org", "3", "3");
        ...
        assertEquals(cert.getDriftzero()[cert.getDriftzero().length-1], new CusumDrift("3.9", "10.776", "0", false));
    }
    ...
    @Test void checkdrift2(){
        ...
        assertEquals(cert.getDriftzero()[cert.getDriftzero().length-1], new CusumDrift("6", "8.991", "0", false));
    }
    ...
    @Test void checkprecision1(){
        ...
        assertEquals(cert.getPrecisionzero()[cert.getPrecisionzero().length-1], new CusumPrecision("3.9", "0.3", "0.045","-16.605", true));
    }
    ...
    @Test void checkprecision2(){
        ...
        assertEquals(cert.getPrecisionzero()[cert.getPrecisionzero().length-1], new CusumPrecision("6", "7.5", "28.125","142.425", false));
    }
}
